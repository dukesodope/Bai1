...
const DATA = [
  {
    ...
    content: "Vũ Văn Hoàng sắp đến hạn lúc 01/08/2020",
  ...
  },
  {
    ...
    content: "Bạn có 17 công việc bị quá hạn.Hãy kiểm tra và lên kế hoạch công việc",
    time: "22/08/2020, 08:00",
    status: "done"
  },
];
...
const Item = ({ title, content, time, status }: ItemProps) => (
  <View style={[styles.item, status === 'unread' && styles.unreadItem]}>
    <Image
      source={status === 'unread' ? require('../../assets/images/favicon.png') : require('../../assets/images/splash.png')}
      style={styles.icon}
    />
